...
const CITIES = {
    bogota: { name: "Bogota", lat: 4.6097, lon: -74.0817 },
    medellin: { name: "Medelin", lat: 6.2442, lon: -75.5812 },
...
let routes = JSON.parse(localStorage.getItem('rutas_seguras_data')) || [
    {
        ...
        departureTime: '06:15',
        students: [
            { id: 'E-520', name: 'Samuel Torres', age: 10, grade: '5-01' },
            { id: 'E-841', name: 'Sofia Restrepo', age: 8, grade: '3-02' }
        ]
    },
    {
        id: 'r2',
        ...
        departureTime: '06:45',
        students: [
            { id: 'E-312', name: 'Mariana Gomez', age: 11, grade: '6-03 C' }
        ]
    }
];
let editingId = null;
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const students = [
            { id: 'E-101', name: 'Tomas Zorro', route: 'Ruta Norte' },
            { id: 'E-102', name: 'Alejandro Solano', route: 'Ruta Sur' },
            { id: 'E-103', name: 'Mario Salazar', route: 'Ruta Centro' },
            { id: 'E-104', name: 'Vanessa Diaz', route: 'Ruta Norte' },
            { id: 'E-105', name: 'Carlos Vega', route: 'Ruta Sur' },
            { id: 'E-106', name: 'Laura Torres', route: 'Ruta Centro' },
        ];
    
        const studentListContainer = document.getElementById('student-list-container');
        const filterSelect = document.getElementById('route-filter');
    
        function renderStudentList(filter = 'Todas') {
            studentListContainer.innerHTML = ''; 
            const filteredStudents = filter === 'Todas' ? students : students.filter(s => s.route === filter);
    
            filteredStudents.forEach(student => {
                const studentItem = document.createElement('div');
                studentItem.className = `student-item ${getRouteClass(student.route)}`;
        ...
        function getRouteClass(route) {
            switch (route) {
                case 'Ruta Norte': return 'route-norte';
                case 'Ruta Sur': return 'route-sur';
                case 'Ruta Centro': return 'route-centro';
                default: return '';
            }
        }
